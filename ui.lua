...
ThemeConfigs.DarkTheme = {
	Values = {
		...
		ErrorText = Color3.fromRGB(255, 0, 0),

		FrameBg = Color3.fromRGB(53, 53, 53),
		...
		RadioButtonHoveredBg = Color3.fromRGB(80, 80, 80),
		ResizeGrab = Color3.fromRGB(120, 120, 120),
		HeaderBg = Color3.fromRGB(30, 30, 30),
		HeaderBgTransparency = 0.7,
		HistogramBar = Color3.fromRGB(200, 200, 0),
		ProgressBar = Color3.fromRGB(200, 200, 0),
		RegionBg = Color3.fromRGB(0, 0, 0),
		RegionBgTransparency = 0.1,
		Separator = Color3.fromRGB(100, 100, 100), 
		SeparatorTransparency = 0.5,
		ConsoleLineNumbers = Color3.fromRGB(255, 255, 255),
		...
		TitleBarBg = Color3.fromRGB(27, 27, 27), 
		TitleBarTransparency = 0,
		TitleActive = Color3.fromRGB(255, 255, 255),
